/*global jQuery, $, d3, describe, before, beforeEach, Bridle, it*/
(function() {
  'use strict';
  ...
  describe("bar chart initial load", function() {
    ...
    it('creates svg', function() {
      ...
      parseInt(svg.attr("width"), 10).should.equal(800);
      parseInt(svg.attr("height"), 10).should.equal(400);
  ...
  describe("bar chart - legend mouseover", function() {
    ...
    it('increases opacity of series rects', function() {
      ...
      parseInt(observedOpacity, 10).should.equal(1);
    });
  ...
  describe("bar chart - rect mouseover", function() {
    ...
    it('tooltip div gets created', function() {
      var tooltip = d3.selectAll('.bridle.tooltip');
